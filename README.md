...
The `pnpm-workspace.yaml` pins the `@deepseek-ai/dsh-*` peer packages to the exact `0.1.1-rc.2` versions — the registry only publishes prereleases, which a bare `>=0.0.1` range cannot match.

 ...
 * Cordis fiber.
 * @module dsh-tui/extension/types
 */
...
export type TuiOverlayAnchor = 'center' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' | 'top-center' | 'bottom-center' | 'left-center' | 'right-center';
...
export type TuiOverlayCloseReason = 'closed' | 'aborted' | 'owner-disposed' | 'tui-disposed' | 'error';

 ...
 */
export function transcriptToolCallIds(session) {
    const ids = new Set();
 ...
 */
export function isCompactCheckpoint(event) {
 ...
 */
export function sessionReferenceCard(source) {
    if (typeof source !== 'object' || source === null)
        return undefined;
    const record = source;
    if (record['kind'] !== 'session-reference' || !Array.isArray(record['references']))
        return undefined;
